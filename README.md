...
- **Persistent Storage**: Tasks are saved automatically in browser localStorage
- **Task Management**:
  - Add new tasks
...
3. **Delete a Task**: Click the × button on the right side of any task to remove it
...
- **Event Delegation**: Efficient event handling for dynamic task list
...
- **Colors**: Update the CSS variables for different color schemes
